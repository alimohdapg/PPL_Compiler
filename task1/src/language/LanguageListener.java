...
public interface LanguageListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link LanguageParser#wholeprog}.
	 * @param ctx the parse tree
	 */
	void enterWholeprog(LanguageParser.WholeprogContext ctx);
	/**
	 * Exit a parse tree produced by {@link LanguageParser#wholeprog}.
	 * @param ctx the parse tree
	 */
	void exitWholeprog(LanguageParser.WholeprogContext ctx);
	/**
